...
public class Runner {
	...
	// run the program, read the file, then parse the data into useable FSA
	...
	// parse the input and place into the correct fsa fields using a predetermined
	// format
	private static void inputParser() {
		...
		while (currentLine < maxLine) {
			...
			while (input.get(currentLine).charAt(0) == '(')// add the transition functions, till no more transition
			                                               // functions are in the input
			{
